    ...
    return(
        ...
        <div id='nav' className='collapse navbar-collapse text-white justify-content-between container'>
            ...
            <ul className='navbar-nav fs-5'>
               ...
               <a href="https://marketkhalidseiko.netlify.app/dashbord/login" className='mx-3 nav-link pointer'><FontAwesomeIcon className='mx-2 fa-beat fs-5' icon={faCircleUser} style={{"--fa-primary-color": "#ffffff", "--fa-secondary-color": "#000000", "--fa-secondary-opacity": "1",}} />Login</a>
